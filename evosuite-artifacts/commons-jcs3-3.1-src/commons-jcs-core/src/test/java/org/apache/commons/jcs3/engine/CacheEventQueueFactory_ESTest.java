...
public class CacheEventQueueFactory_ESTest extends CacheEventQueueFactory_ESTest_scaffolding {
  ...
  public void test5()  throws Throwable  {
      CacheEventQueueFactory<String, Object> cacheEventQueueFactory0 = new CacheEventQueueFactory<String, Object>();
      ArrayList<RemoteCacheNoWait<String, Object>> arrayList0 = new ArrayList<RemoteCacheNoWait<String, Object>>();
      RemoteCacheAttributes remoteCacheAttributes0 = new RemoteCacheAttributes();
      CacheEventLoggerDebugLogger cacheEventLoggerDebugLogger0 = new CacheEventLoggerDebugLogger();
      EncryptingSerializer encryptingSerializer0 = new EncryptingSerializer();
      RemoteCacheFactory remoteCacheFactory0 = new RemoteCacheFactory();
      RemoteCacheNoWaitFacade<String, Object> remoteCacheNoWaitFacade0 = new RemoteCacheNoWaitFacade<String, Object>(arrayList0, remoteCacheAttributes0, cacheEventLoggerDebugLogger0, encryptingSerializer0, remoteCacheFactory0);
      CacheAdaptor<String, Object> cacheAdaptor0 = new CacheAdaptor<String, Object>(remoteCacheNoWaitFacade0);
      ICacheEventQueue.QueueType iCacheEventQueue_QueueType0 = ICacheEventQueue.QueueType.POOLED;
      // Undeclared exception!
      try { 
        cacheEventQueueFactory0.createCacheEventQueue((ICacheListener<String, Object>) cacheAdaptor0, 2316L, "", 2, 8080, "My", (ICacheEventQueue.QueueType) iCacheEventQueue_QueueType0);
