...
public class AbstractRemoteAuxiliaryCache_ESTest extends AbstractRemoteAuxiliaryCache_ESTest_scaffolding {
  ...
  public void test31()  throws Throwable  {
      RemoteCacheAttributes remoteCacheAttributes0 = new RemoteCacheAttributes();
      ZombieCacheServiceNonLocal<InputStream, Integer> zombieCacheServiceNonLocal0 = new ZombieCacheServiceNonLocal<InputStream, Integer>(0);
      remoteCacheAttributes0.setGetTimeoutMillis(10);
      RemoteCacheMonitor remoteCacheMonitor0 = new RemoteCacheMonitor();
      RemoteCache<InputStream, Integer> remoteCache0 = null;
      try {
        remoteCache0 = new RemoteCache<InputStream, Integer>(remoteCacheAttributes0, zombieCacheServiceNonLocal0, (IRemoteCacheListener<InputStream, Integer>) null, remoteCacheMonitor0);
       //  fail("Expecting exception: NullPointerException");
       // Unstable assertion
      } catch(NullPointerException e) {
         //
