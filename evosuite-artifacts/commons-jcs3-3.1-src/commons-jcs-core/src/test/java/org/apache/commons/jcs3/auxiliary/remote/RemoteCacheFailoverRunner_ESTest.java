...
public class RemoteCacheFailoverRunner_ESTest extends RemoteCacheFailoverRunner_ESTest_scaffolding {
  ...
  public void test3()  throws Throwable  {
      ArrayList<RemoteCacheNoWait<Delayed, Object>> arrayList0 = new ArrayList<RemoteCacheNoWait<Delayed, Object>>();
      RemoteCacheAttributes remoteCacheAttributes0 = new RemoteCacheAttributes();
      CacheEventLoggerDebugLogger cacheEventLoggerDebugLogger0 = new CacheEventLoggerDebugLogger();
      CompressingSerializer compressingSerializer0 = new CompressingSerializer();
      EncryptingSerializer encryptingSerializer0 = new EncryptingSerializer(compressingSerializer0);
      RemoteCacheNoWaitFacade<Delayed, Object> remoteCacheNoWaitFacade0 = new RemoteCacheNoWaitFacade<Delayed, Object>(arrayList0, remoteCacheAttributes0, cacheEventLoggerDebugLogger0, encryptingSerializer0, (RemoteCacheFactory) null);
      RemoteCacheFailoverRunner<Delayed, Object> remoteCacheFailoverRunner0 = new RemoteCacheFailoverRunner<Delayed, Object>(remoteCacheNoWaitFacade0, (RemoteCacheFactory) null);
      remoteCacheFailoverRunner0.dispose();
      //  // Unstable assertion: assertFalse(remoteCacheFailoverRunner0.isDaemon());
  }
}
