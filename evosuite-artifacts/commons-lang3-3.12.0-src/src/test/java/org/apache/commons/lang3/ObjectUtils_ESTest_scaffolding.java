...
public class ObjectUtils_ESTest_scaffolding {
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("java.util.function.Supplier", false, ObjectUtils_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.util.function.ToDoubleFunction", false, ObjectUtils_ESTest_scaffolding.class.getClassLoader()));
  }
